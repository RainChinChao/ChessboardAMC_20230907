...
sample_no1=2000;
rcv1_origin=IQ_final_samples*800;
...
if (ri==1)
    rcv_tmp=rcv1_0((i-1)*sample_no1+1:i*sample_no1)+XY_scale+XY_scale*1i;
    weights_test=zeros(100);
elseif (ri==2)
    rcv_tmp=rcv1_pi4m((i-1)*sample_no1+1:i*sample_no1)+XY_scale+XY_scale*1i;
    weights_test=zeros(100);
elseif (ri==3)
    rcv_tmp=rcv1_pi4p((i-1)*sample_no1+1:i*sample_no1)+XY_scale+XY_scale*1i;
    weights_test=zeros(100);
elseif (ri==4)
    rcv_tmp=rcv1_pi2p((i-1)*sample_no1+1:i*sample_no1)+XY_scale+XY_scale*1i;
    weights_test=zeros(100);
end
